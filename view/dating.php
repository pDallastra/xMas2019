    ...
    <section class="flex row">
        ...
        <div class="main-container flex col center">
            ...
            <div class="img-triple flex row center">
                ...
                <div class="img-text flex col">
                    <img src="../img/dating7.jpg" alt="">
                    <p>Her family didn't approved our relationship, but we loved each other so much already. The picture of the Temple saying: "This is Our Goal" didn't look like to be real at the time.</p>
                </div>
            </div>
            <div class="img-triple flex row center">
                <div class="img-text flex col">
            ...
            <div class="flex row center">
                <button><a href="dallastra.php">Previous</a></button>
                <button><a href="mission.php">Next</a></button>
            </div>
